...
Subsystem detailed in `docs/active/RADAR_TRACKING_*`, `RADAR_ALERTS.md`, `docs/archive/RADAR_FORMATION_FLIGHT.md` (ADR-033/035/036). Largely shipped (ADS-B online + receivers + via-MSP, conflict alerts, FormationFlight). Open items:
