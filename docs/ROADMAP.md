...
- [~] HID controller input (gamepad/joystick) — joystick/HID phase of **Vehicle control** above. **In
  progress (Phases 1–4, pending on-hardware test):** native HID backend, channel-mapping profiles, safety
  locks, and the live MSP send pipeline (CH1–16 RAW_RC / CH17–32 AUX_RC, engage gate, seed-on-connect,
  deadman, link probe). See `docs/active/RC_CONTROL.md`.
