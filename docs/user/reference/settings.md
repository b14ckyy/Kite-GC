...
| **Wind** | Request wind-estimate telemetry (shown on the compass widget). Live wind needs **ArduPilot**, or **INAV 10.0+** — on older INAV the toggle stays without effect. Replay always shows the wind a log recorded. | Off |
